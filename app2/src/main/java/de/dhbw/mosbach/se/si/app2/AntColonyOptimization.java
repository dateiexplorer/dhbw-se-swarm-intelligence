...
public class AntColonyOptimization {
    ...
    private void setupAnts() {
        ...
        for (int i = 0; i < numOfAnts; i++) {
            ...
            // ants and each iteration without further adjustments.
     ...
     * function fot the updatePheromoneMatirx.
     * 
     ...
     * This value is useful for a terminate condition.
     * If most of the ants chose the same (best) trail, the algorithm
     * convergate to a solution (which is near to the global optimum solution).
     * 
     * @param trails - the solutions generated by the ants for the current
     *               iteration
